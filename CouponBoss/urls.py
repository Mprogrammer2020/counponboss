...
urlpatterns = [
    ...
    path('apis/getcountriesbybrands', api_views.GetCountriesByBrand, name='GetCountriesByBrand'),
    path('apis/getbrandsbycountry', api_views.GetBrandsBycountry, name='GetBrandsBycountry'),
    ...
    path('terms_conditions_ar', api_views.Terms_Conditions_ar),
    path('about_us', api_views.About_Us),
    path('about_us_ar', api_views.About_Us_ar),
    path('faq', api_views.FAQ),
    path('faq_ar', api_views.FAQ_ar),
    path('privacy_policy', api_views.Privacy_Policy),
    path('privacy_policy_ar', api_views.Privacy_Policy_ar),
    path('help', api_views.Help),
    path('help_ar', api_views.Help_ar),
