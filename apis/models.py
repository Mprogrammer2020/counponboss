...
class Coupon(models.Model):
    ...
    discount_ar = models.DecimalField(max_digits=9, decimal_places=6, null=True)
    store_link = models.CharField(max_length=255, default="")
    store_link_ar = models.CharField(max_length=255, default="")
    video_link = models.CharField(max_length=255, default="")
    video_link_ar = models.CharField(max_length=255, default="")
    code = models.CharField(max_length=50, default="")
    code_ar = models.CharField(max_length=50, default="")
    image = models.CharField(max_length=255, default="")
    status = models.IntegerField(default=1)
    headline = models.CharField(max_length=255, default="")
    headline_ar = models.CharField(max_length=255, default="")
    created_time = models.DateTimeField()
